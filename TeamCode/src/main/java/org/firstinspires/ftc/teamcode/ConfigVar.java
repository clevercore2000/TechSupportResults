...
public class ConfigVar {
    ...
    public static class ArmCfg{
        ...
        public static double gripperSpeed= 0.75;

        public static double HANDLER_MIN = 0;
        public static double HANDLER_MAX = 180;
        public static double handlerOpened = 80;
        public static double handlerClosed = 100;
        public static double handlerSpeed = 1.6; // deg/sec

        public static double TRANSFER_MIN = 0;
        public static double TRANSFER_MAX = 180;
        public static double transferSpPreCoop = 80;
        public static double transferSpCoop = 100;
        ...
        public static double poleSpeed= 0.75;

        public static double TURNER_MIN = 0;
        public static double TURNER_MAX = 1800;
        public static double turnerIdle = 900;
        public static double turnerFlipped = 800;
        public static double turnerSpeed= 1.5;
