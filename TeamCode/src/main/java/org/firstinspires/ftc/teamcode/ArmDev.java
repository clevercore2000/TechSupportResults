...
Cum folosim clasa:
In MainOpMode sau AutoOpMode declaram obiecte servo de care avem nevoi. De exemplu:
ArmDev  armGripper;
ArmDev  armHandler;
ArmDev  armTransfer;
ArmDev  armPole;
...
{
    /*
    hardware attribute is deprecated
     */
//    Hardware hardware;
    enum  ServoState{servoReady, servoMove};
    Servo servo;
    private String gIndex;
    String getgIndex(){ return gIndex; }
    //    ConfigVar configVar;
    ...
    void setRange( double in_minRange, double in_maxRange )
    {
    ...
    double mapRange(double inValue)
    {
